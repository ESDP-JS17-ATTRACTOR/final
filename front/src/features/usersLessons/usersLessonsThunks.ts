...
export const fetchUsersLessons = createAsyncThunk<UsersLesson[]>('usersLessons/fetchAll', async () => {
  try {
...
export const fetchOneUsersLesson = createAsyncThunk<UsersLesson, string>('usersLessons/fetchOne', async (id) => {
  try {
...
export const createUsersLessons = createAsyncThunk<void, number>('usersLessons/createAll', async (courseId) => {
  try {
