...
import {selectCategories, selectCategoriesLoading, selectCategoryDeleting} from "@/features/categories/categoriesSlice";
import {
    Box,
    Button,
    CircularProgress,
    ...
    return (
        <>
            <Box display="flex" alignItems="center" justifyContent="space-between">
                ...
                <Button> <Link href="/admin/addCategory">Добавить категорию</Link></Button>
            </Box>
                                ...
                                >
                                    ...
                                    <TableCell align="center">
                                        <Button variant="outlined">
                                            <Link href={`/admin/editCategory/${category.id}`}><EditIcon/></Link>
                                        </Button>
                                    </TableCell>
                                </TableRow>
                            ))}
